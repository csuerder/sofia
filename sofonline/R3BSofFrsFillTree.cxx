...
InitStatus R3BSofFrsFillTree::Init()
{
    ...
    //FrsTree -> Branch("Gamma_S2_Cave", &Gamma_S2_Cave);
    ...
    //FrsTree -> Branch("Gamma_S2_S8", &Gamma_S2_S8);
    ...
    //FrsTree -> Branch("Gamma_S8_Cave", &Gamma_S8_Cave);
    ...
    cTwimvsMusicZ_betacorrected = new TCanvas("TwimvsMusicZ_betacorrected", "Beta corrected Z correlation between two MUSICs", 10, 10, 800, 700);
    fh2_TwimvsMusicZ_betacorrected = new TH2F("fh2_TwimvsMusicZ_betacorrected", "Twim vs Music: Beta corrected charge Z", 1000, 6, 38, 1000, 6, 38);
...
void R3BSofFrsFillTree::Exec(Option_t* option)
{
  FairRootManager* mgr = FairRootManager::Instance();
	...
	Int_t d,t;
	    ...
	    if (MusicE > 0){ // && xs2!=-10000.){ //&& toff!=-10000.) {
	      ...
	      //
	      TheBeta = Beta_S2_S8; TheGamma = Gamma_S2_S8; TheBrho = Brho_S2_S8;
	      MusicZ = fZ0 + fZ1 * TMath::Sqrt(MusicE) * TheBeta
		+ fZ2 * MusicE * TheBeta * TheBeta;// mostly first order
...
void R3BSofFrsFillTree::FinishEvent()
{
  ...
  Tof_wTref_S2_S8 = -10000., Beta_S2_S8 = -10000., Gamma_S2_S8 = -10000., Brho_S2_S8 = -10000.;
  Tof_wTref_S8_Cave = -10000., Beta_S8_Cave = -10000., Gamma_S8_Cave = -10000., Brho_S8_Cave = -10000.;
  AoQ_S2_Cave = -10000., AoQ_S2_S8 = -10000., AoQ_S8_Cave = -10000.;
  //
  if (fMappedItemsSci)
    {
