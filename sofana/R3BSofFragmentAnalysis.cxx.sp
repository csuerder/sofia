...
Double_t const c = 29.97924580;     // Light velocity (cm/ns)
Double_t const e = 1.60217662e-19;  // Electron charge (C)
Double_t const u = 1.660538921e-27; // Atomic mass unit (kg)
